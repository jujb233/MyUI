// src/styles/config/base.ts

/**
 * @description Base variables for the design system.
 * These are the raw values that can be used to build themes or component styles.
 */
